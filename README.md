...
```
git clone https://github.com/manish7065/Deep-Authenticator-Frontend.git
```
...
#### Please refer this [documentation](https://github.com/Rishav-hub/Deep-Face-Authenticator/blob/main/docs/manual_setup.md) for deployment to Azure.
